...
/**
 * MessageBody bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class MessageBody implements org.apache.axis2.databinding.ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":MessageBody", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"MessageBody", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static MessageBody parse(javax.xml.stream.XMLStreamReader reader)
						...
						if (!"MessageBody".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (MessageBody) pdp.identity_federation.picketlink.ExtensionMapper
